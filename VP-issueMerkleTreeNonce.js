...
const { deflate, inflate,  unzip } = require('node:zlib');
...
async function createVCPayload(user,nClaims) {
    ...
    // console.log("la lilsta delle cred è : ")
    // console.log(cred);
...
let j=1
    ...
    const file = fs.createWriteStream('test_Creation_VP_Compression_TEST_COMPARATIVO.txt');
